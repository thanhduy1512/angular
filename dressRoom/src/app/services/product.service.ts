...
export class ProductService {
  ...
  setSelectedProducts(img, type) {
    const currentSelectedProduct = this.selectedProducts.getValue();
    this.selectedProducts.next({ ...currentSelectedProduct, [type]: img });
    // this.selectedProductsEmitter.emit(this.selectedProducts);
  }
